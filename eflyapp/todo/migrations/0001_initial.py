    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lugarNaci', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cities_light.city')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precioPrimeraDesc', models.IntegerField(null=True)),
                ('precioEconomicaDesc', models.IntegerField(null=True)),
                ('destino', models.ForeignKey(limit_choices_to={'name__in': ['Pereira', 'Bogotá', 'Medellín']}, on_delete=django.db.models.deletion.CASCADE, related_name='destinos', to='cities_light.city')),
                ('origen', models.ForeignKey(limit_choices_to={'name__in': ['Pereira', 'Bogotá', 'Medellín']}, on_delete=django.db.models.deletion.CASCADE, related_name='origenes', to='cities_light.city')),
            ],
        ),
        migrations.CreateModel(
            name='Ticket',
